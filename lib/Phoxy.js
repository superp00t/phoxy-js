...
Phoxy.prototype.acquirePairingToken = function() {
  var $this = this;

  return new etc.Req({
    method:   "GET",
    respType: "buffer",
    url:      $this.url.subPath("/v1/zdb/acquirePairingToken")
    ...
    var e = new etc.Buffer(t.data);
    return e.readString();
  });
}

Phoxy.prototype.upgradePairingToken = function() {
  var $this = this;

  return new etc.Req({
    method:   "GET",
    respType: "buffer",
    url:      $this.url.subPath("/v1/zdb/upgradePairingToken")
    .setQ("t", $this.token).toString()
  }).do().then(function(t) {
    if (t.status !== 200) {
      return Op.FAIL;
